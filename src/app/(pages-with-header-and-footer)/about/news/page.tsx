    ...
    <div className={styles.pressContainer}>
      ...
      <div className={styles.section}>
        ...
        <span>
          ...
          own template from scratch. We are looking forward to see what you will
          create.
        </span>
      </div>
      <div className={styles.section}>
        ...
        <span>
          ...
          total have answered your form and how many people have answered each.
          This will help you to orginize your data and make it easier to
          understand.
        </span>
      </div>
      <div className={styles.section}>
        ...
        <span>
          ...
          redesigned the dashboard to make it easier to use and more intuitive.
          We hope you like it. Feel free to give us feedback on the new design.
        </span>
      </div>
      <div className={styles.section}>
        <div>
