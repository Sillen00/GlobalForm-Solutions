...
const dashboardMetadata = {
  title: "Press - GlobalForm Solutions",
}
    ...
    <>
      ...
      <div className={styles.pressContainer}>
        ...
        <div className={styles.section}>
          ...
          <span>
            The people have spoken and we have listened. We are proud to
            announce that the stockholders have voted to replace the current CEO
            Simon Bengtsson. The main reason for this was the lack of attendence
            at the annual meeting. He decided that he want to have a vacation
            instead of attending the meeting. We are now looking for a new CEO.
          </span>
        </div>
        <div className={styles.section}>
          <div>
          ...
          <span>
            ...
            are also using sophisticated software to break into your computer
            and steal your information. So, if you want to protect yourself from
        ...
        <div className={styles.section}>
          ...
          <span>
            ...
            Stockexchange. We are looking forward to a bright future with our
            new investors.
          </span>
        </div>
        <div className={styles.section}>
          ...
          <span>
            ...
            members. The new board members are: - Marcus Rosin Lindeberg -
            Thomas Ingvarsson - Arnold Schwarzenegger
          </span>
        </div>
      </div>
    </>
